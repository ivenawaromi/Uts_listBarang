...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(Vite::asset('resources/img/slide3.jpg')); ?>" class="d-block img-fluid w-100" alt="Laundry Shop">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(Vite::asset('resources/img/slide1.png')); ?>" class="d-block img-fluid w-100" alt="Laundry Room">
                <div class="carousel-caption d-none d-md-block">
                    <h5>Laundry Room</h5>
            ...
            <div class="carousel-item">
                <img src="<?php echo e(Vite::asset('resources/img/slid2.jpg')); ?>" class="d-img-fluid w-100" alt="Detergen">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col my-2 text-center">
                <a href="<?php echo e(route('laundry.index')); ?>" class="bd-placeholder-img" type="button">
                    <img src="<?php echo e(Vite::asset('resources/img/c1.jpg' )); ?>" alt="Detergen" class="rounded-circle" width="140" height="140">
                </a>
                <h5>Detergen</h5>
            </div>
            <div class="col my-2 text-center">
                <a href="<?php echo e(route('laundry.index')); ?>" class="bd-placeholder-img" type="button">
                    <img src="<?php echo e(Vite::asset('resources/img/c2.png')); ?>" alt="Washing Equipment" class="rounded-circle" width="140" height="140">
                </a>
                <h5>Washing Equipment</h5>
            </div>
            <div class="col my-2 text-center">
                <a href="<?php echo e(route('laundry.index')); ?>" class="bd-placeholder-img" type="button">
                    <img src="<?php echo e(Vite::asset('resources/img/c3.jpg')); ?>" alt="Washing Supplies" class="rounded-circle" width="140" height="140">
                </a>
    ...
    <div class="row">
        <div class="col-md-5 mt-5">
            <img src="<?php echo e(Vite::asset('resources/img/laundry.jpg')); ?>" class="img-thumbnail mt-4" alt="logo">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\framework\uts_listBarang\resources\views/home.blade.php ENDPATH**/ ?>